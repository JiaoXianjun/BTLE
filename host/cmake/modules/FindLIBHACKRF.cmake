...
if (LIBHACKRF_INCLUDE_DIR AND LIBHACKRF_LIBRARIES)
  ...
  IF (LIBHACKRF_LIBRARIES AND LIBHACKRF_INCLUDE_DIR)
    SET(LIBHACKRF_FOUND "YES")
  ELSE (LIBHACKRF_LIBRARIES AND LIBHACKRF_INCLUDE_DIR)
    SET(LIBHACKRF_FOUND "NO")
  ENDIF (LIBHACKRF_LIBRARIES AND LIBHACKRF_INCLUDE_DIR)
...
#    IF (LIBBLADERF_FIND_REQUIRED)
      MESSAGE(STATUS "Could not find BLADERF library")
