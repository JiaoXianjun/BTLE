...
localparam integer MEM_SIZE_IN_BIT = ((1<<ADDRESS_WIDTH)*DATA_WIDTH);
...
//  <-----Cut code below this line---->
   ...
   xpm_memory_sdpram_inst (
      ...
      .addra(write_address),                   // ADDR_WIDTH_A-bit input: Address for port A write operations.
      .addrb(read_address),                   // ADDR_WIDTH_B-bit input: Address for port B read operations.
