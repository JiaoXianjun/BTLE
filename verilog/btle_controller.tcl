...
# Check if _xil_proj_name_ is a file (generated by iverilog) and delete it
if {[file exists $_xil_proj_name_] && [file isfile $_xil_proj_name_]} {
    file delete $_xil_proj_name_
    puts "Deleted file: $_xil_proj_name_"
}
...
set_property -name "top" -value "btle_controller" -objects $obj
